...
function getIcosahedronHeight(icosahedron) {
  return function callbackFunction() {
    return new Cesium.Cartesian3.fromDegreesArrayHeights([icosahedron[0][0], icosahedron[0][1], icoHeight, icosahedron[1][0], icosahedron[1][1], icoHeight, icosahedron[2][0], icosahedron[2][1], icoHeight]);
  };
}
...
const goldEllipsoid = viewer.entities.add({
  ...
  ellipsoid: {
    ...
    material: Cesium.Color.GOLD.withAlpha(0.95),
  },
});
